...
const SQUARE_DEFINITIONS: readonly SquareDefinition[] = [
  ...
  gift(4, '入学祝い'),
  normal(5, 'アルバイト開始', 'EV_STUDENT_04', 1_300, -2, 0),
  ...
  normal(12, '大学卒業・社会人へ', 'EV_STUDENT_10', 1_300, 3, 5),
  stop(13, '職業選択', 'PROCESS_JOB_SELECTION'),
  normal(14, '初出勤', 'EV_SQUARE_14', 1_100, -2, 0),
  normal(15, '初契約', 'EV_WORK_01', 1_400, -2, 0),
  gift(16, '会社のビンゴ大会'),
  normal(17, '顧客から断られる', 'EV_WORK_02', -100, -3, 0),
  normal(18, '初ボーナス', 'EV_WORK_03', 1_700, 0, 2),
  normal(19, '深夜まで残業', 'EV_WORK_04', 1_500, -10, -5),
  stop(20, 'NISAを始めるか', 'PROCESS_NISA_SELECTION'),
  normal(21, '投資の勉強', 'EV_SQUARE_21', -100, -1, 0),
  gift(22, 'キャンペーン当選'),
  normal(23, '上司に怒られる', 'EV_SQUARE_23', -100, -5, -2),
  normal(24, '大型契約を獲得', 'EV_WORK_05', 2_000, -8, -3),
  ...
  normal(49, '仕事の繁忙期', 'EV_SQUARE_49', 1_500, -8, -5),
  gift(50, '会社の抽選会'),
  ...
  normal(56, '仕事で大成功', 'EV_SQUARE_56', 2_000, -8, -3),
  gift(57, '29歳の誕生日'),
  normal(58, '家族との休日', 'EV_SQUARE_58', -100, 5, 12),
  normal(59, '最後の人生イベント', 'EV_SQUARE_59', 1_300, 3, 5),
  {
    id: 60,
    type: 'goal',
    label: 'ゴール',
